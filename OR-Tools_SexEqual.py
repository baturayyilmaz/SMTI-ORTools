...
def main():
    ...
    # sumMan = m.NewIntVar(lb=-100000000000, ub=10000000000, name="sumMan")
    # sumWoman = m.NewIntVar(lb=-100000000000, ub=10000000000, name="sumWoman")
    # sumTemp = m.NewIntVar(lb=-10000000000, ub=10000000000, name="sumTemp")
    # diff = m.NewIntVar(lb=-10000000000, ub=10000000000, name="diff")
